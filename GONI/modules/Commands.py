...
from GONI.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@GONI.on_message(filters.command("status"))
...
@GONI.on_message(filters.command(["lang", "language", "setlang"]))
...
@GONI.on_message(filters.command(["resetlang", "nolang"]))
...
@GONI.on_message(filters.command("chatbot"))
